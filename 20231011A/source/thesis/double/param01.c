...
void	main() {					
	...
	ans = func00();		
	#ifdef _DEBUG
		CIDebug.vdouble("func00 result1 >>>",ans,100.0f);
	#endif

	ans = func01(100.0);		
	#ifdef _DEBUG
		CIDebug.vdouble("func01 result1 >>>",ans,100.0f);
	#endif

	ans = func02(100.0,200.0);		
	#ifdef _DEBUG
		CIDebug.vdouble("func02 result1 >>>",ans,300.0f);
	#endif

	ans = func03(100.0,200.0,300.0);		
	#ifdef _DEBUG
		CIDebug.vdouble("func03 result1 >>>",ans,600.0f);
	#endif

	ans = func04(100.0,200.0,300.0,400.0);		
	#ifdef _DEBUG
		CIDebug.vdouble("func04 result1 >>>",ans,1000.0f);
	#endif

	ans = func05(100.0,200.0,300.0,400.0,500.0);		
	#ifdef _DEBUG
		CIDebug.vdouble("func05 result1 >>>",ans,1500.0f);
	#endif

	ans = func06(100.0,200.0,300.0,400.0,500.0,600.0);		
	#ifdef _DEBUG
		CIDebug.vdouble("func06 result1 >>>",ans,2100.0f);
	#endif

	ans = func07(100.0,200.0,300.0,400.0,500.0,600.0,700.0);		
	#ifdef _DEBUG
		CIDebug.vdouble("func07 result1 >>>",ans,2800.0f);
	#endif

	ans = func08(100.0,200.0,300.0,400.0,500.0,600.0,700.0,800.0);		
	#ifdef _DEBUG
		CIDebug.vdouble("func08 result1 >>>",ans,3600.0f);
	#endif

	ans = func09(100.0,200.0,300.0,400.0,500.0,600.0,700.0,800.0,900.0);		
	#ifdef _DEBUG
		CIDebug.vdouble("func09 result1 >>>",ans,4500.0f);
	#endif
...
//	ans = func10(val01,val02,val03,val04,val05,val06,val07,val08,val09,val10);		
	...
	#ifdef _DEBUG
		CIDebug.vdouble("func10 result1 >>>",ans,5500.0f);
	#endif
